...
- Read data set (from anywhere )
- convert raw data into dataframe
- use train_test_split method to convert raw dataframe into train and test dataframes
- return train and test set to the next step i.e data tranformation
